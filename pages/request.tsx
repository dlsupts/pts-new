	...
	return (
		<div className="main-height flex flex-col justify-center px-4">
			<div className="grid place-items-center lg:grid-cols-2 mx-auto h-full container min-h-[10rem] container">
				...
				<div className="flex flex-col items-center mb-20 lg:mb-auto pt-10 lg:pt-0 lg:pl-8 border-gray-300 lg:border-l lg:border-t-0 border-t">
					<div className="mb-6">
					...
					<select onChange={e => setHelp(e.target.value)}
						className="w-full border px-3 py-1.5 bg-clip-padding rounded transition ease-in-out cursor-pointer">
